...
class SudokuMatrix:
    """Class that creates the matrix for the game according to
    ...
    def insert_number(self, number: int, coordinates: tuple):
        ...
        Args:
            ...
            coordinates (tuple): the x, y coordinates of the insertion
            counting from 0 to 8, from left to right and from top to down
        Returns:
    ...
    def __str__(self):
        """Helper function to print sudoku-matrix.
        Returns:
            str: the sudoku matrix in str format.
        """
        sudokustring = ""
        for row in self.matrix:
            for c in row:
    ...
    def __getitem__(self, x: int):
        """Helper function to access a row.
        """
        return self.matrix[x]

    def __iter__(self):
        """Helper function to enable iteration.
        """
        self.n = 0        
        return self
